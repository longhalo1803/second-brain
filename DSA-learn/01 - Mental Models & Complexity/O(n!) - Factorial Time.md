...
- **Chiến lược tiếp cận:**
  ...
  3. **Thuật toán xấp xỉ & Heuristic (Approximation Algorithms):** Khi $N$ lớn (như tối ưu lộ trình giao hàng Grab/Shopee), ta chấp nhận tìm lời giải _gần tối ưu_ (sub-optimal) trong vài giây bằng thuật toán Di truyền (Genetic Algorithm), Luyện kim nhân tạo (Simulated Annealing) hoặc Tìm kiếm cục bộ.
